...
public class ArchimateDiagramConnectionPolicy extends GraphicalNodeEditPolicy {
    ...
    protected Command getReconnectCommand(ReconnectRequest request, boolean isSourceCommand) {
        ...
        if(connection instanceof IDiagramModelArchimateConnection && newComponent instanceof IDiagramModelArchimateComponent) {
            return createArchimateReConnectionCommand((IDiagramModelArchimateConnection)connection, (IDiagramModelArchimateComponent)newComponent, isSourceCommand);
        }
    ...
    private Command createArchimateReConnectionCommand(IDiagramModelArchimateConnection connection, IDiagramModelArchimateComponent dmc, boolean isSourceCommand) {
